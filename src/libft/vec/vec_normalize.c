...
t_vec3f	vec3f_normalize(t_vec3f const *v)
{
	float	l;
...
t_vec3d	vec3d_normalize(t_vec3d const *v)
{
	double	l;
...
t_vec4f	vec4f_normalize(t_vec4f const *v)
{
	float	l;
...
t_vec4d	vec4d_normalize(t_vec4d const *v)
{
	double	l;
