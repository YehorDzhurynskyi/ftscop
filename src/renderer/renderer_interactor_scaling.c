...
void			renderer_draw_controls_scaling(
const t_scene_interactor *interactor, const t_mat4f *vp)
{
	...
	rt[0] = (t_vec4f){ 0.0f, 0.0f, M_PI_2, 1.15f + r.x };
	rt[1] = (t_vec4f){ 0.0f, M_PI_2, 0.0f, 1.15f + r.y };
	rt[2] = (t_vec4f){ -M_PI_2, 0.0f, 0.0f, 1.15f + r.z };
