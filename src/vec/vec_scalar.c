...
t_vec3f	vec3f_scalar(t_vec3f const *v, float s)
{
	return ((t_vec3f){v->x * s, v->y * s, v->z * s});
}

t_vec3d	vec3d_scalar(t_vec3d const *v, double s)
{
	return ((t_vec3d){v->x * s, v->y * s, v->z * s});
}

t_vec4f	vec4f_scalar(t_vec4f const *v, float s)
{
	return ((t_vec4f){v->x * s, v->y * s,
	v->z * s, v->w * s});
}

t_vec4d	vec4d_scalar(t_vec4d const *v, double s)
{
